...
//
// Weighted 50/50 between two [0,1] pressures:
...
// supabase/migrations/0016_dynamic_pricing.sql — that SQL copy exists
...
export function computeStockBasedDecayPrice(
  ...
  const decayFactor = 0.5 * timeUrgency + 0.5 * stockPressure;
